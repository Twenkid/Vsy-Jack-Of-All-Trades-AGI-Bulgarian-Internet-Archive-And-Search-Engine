...
def download_places365_subset(
    ...
    if mode == 'class_indices':
        ...
        if skip_n is None:
            raise ValueError("skip_n must be a number")
        target_classes = None
        print(f"Downloading with skippping {skip_n} images from all classes")
    ...
    for idx, item in enumerate(dataset):
        ...
        if mode == 'total_samples':
          should_download = True #slow comparisons       
